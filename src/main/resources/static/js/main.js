...
var lista = ['Vlad','Matei','DEpulasameiie']
...
function onConnected() {
    ...
    stompClient.subscribe('/topic/data.response', function (response) {
        ...
        retrieval(responseData); // Call the retrieval function with the data
...
function retrieval(lista) {
    ...
    console.log(listContainer.innerHTML); // Log the HTML content inside the listContainer
    console.log(listContainer.textContent);
    console.log(listContainer.content);
